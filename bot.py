...
class Chat:
    def __init__(self, msg):
        ...
        self.messages = {
            'start':'👋Hey, '+ self.user_name +'!\n\n'
                    '🎧 I m Music bot I can find songs and download it\n\n Commandes\n'
                    '*/music* _song name_\n'
                    '*/music* _musician name - song name_\n'
                    '*Cradits* _@MusicStremePGBot - @MusicStremePGBot_\n\n',
    ...
    def process_request(self, user_input):
        ...
        if int(min_duration) < 30 and split_count < 3:
            ...
            downloading_message = self.send_message('⬇️ Download started... \n_(Please wait to the response )_')
